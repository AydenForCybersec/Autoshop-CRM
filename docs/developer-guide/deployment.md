...
6. Keep update manager disabled unless explicitly needed (`UPDATE_ENABLED=false` by default in production).
7. Validate login, dashboard, customers, and settings pages.
